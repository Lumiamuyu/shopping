...
import com.lumiamuyu.shopping.dao.CategoryMapper;
...
import com.lumiamuyu.shopping.utils.DateUtils;
import com.lumiamuyu.shopping.utils.FTPUtil;
import com.lumiamuyu.shopping.utils.PropertiesUtils;
import com.lumiamuyu.shopping.vo.ProductDetailVO;
import com.lumiamuyu.shopping.vo.ProductListVO;
...
public class ProductServiceImpl implements IProductService {
    ...
    public ServerResponse set_sale_status(Integer productId, Integer status) {
        ...
        if (result>0){
            return ServerResponse.serverResponseBySuccess("参数修改成功");
        }
        return ServerResponse.serverResponseByError("参数修改失败");
